...
- **Code Institute Tutorials & Walkthrough Projects:** Referenced approaches and steps from Code Institute’s _Love Running_ and _Boardwalk Games_ projects as guidance for structuring and building the website.
...
- **Adobe Stock** (standard license)
  ...
  - Plain t-shirt used for mockup on [Donate Page] by Kay [Link to the image](https://stock.adobe.com/uk/images/t-shirt-mockup-white-blank-t-shirt-front-and-back-views-male-clothes-wearing-clear-attractive-apparel-tshirt-models-template-generative-ai/624964071)
- **Freepik**
...
- Daniel Hamilton – My mentor, whose invaluable guidance, constructive feedback, and encouragement have made a real difference throughout this project. His professionalism and expertise set a standard I truly admire.
